...
export function Experience() {
  ...
  return (
    ...
    >
      <div className="w-full flex flex-col lg:pt-0 pt-16">
          ...
          >
            {experiences.map((experience, index) => (
              <motion.div
                ...
                custom={index}
                className="flex flex-row py-3 mx-4 my-8 lg:w-[420px] w-[340px] h-[140px] shadow-xl rounded-xl bg-content1"
              >
                <div className="flex items-center justify-center p-2 w-2/5">
                  <img
